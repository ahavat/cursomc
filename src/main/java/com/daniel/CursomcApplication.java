...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("12345678", "9869020585"));
		
		Endereco e1 = new Endereco(null, "Rua flores","300", "Apto 303", "Jardim", "3826486151", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos","105", "Sala 800", "Centro", "986582141", cli1, c2);
